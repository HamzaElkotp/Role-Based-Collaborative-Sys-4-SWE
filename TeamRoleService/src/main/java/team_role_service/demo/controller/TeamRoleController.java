package team_role_service.demo.controller;
...
import team_role_service.demo.service.TeamRoleService;
...
public class TeamRoleController {
    ...
    @GetMapping("/projects/{project_id}/memberships/{user_id}/get-user-role")
    public ResponseEntity<Roles> getUserRole(@PathVariable Long project_id, @PathVariable Long user_id) {
        Roles role = teamRoleService.getUserRoleInProject(project_id, user_id);
    ...
    @PostMapping("/projects/{project_id}/memberships/add-new-member")
